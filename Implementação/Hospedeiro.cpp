/**\file Hospedeiro.cpp
 * \brief Ficheiro com a implementação da classe Hospedeiro.
 *
 * PROJECTO: Projecto 2 - Gestão do embarque dos passageiros num aeroporto (check-in/embarque) \n
 * FICHEIRO: Hospedeiro.cpp \n
 * DESCRIÇÃO: Ficheiro com a implementação da classe Hospedeiro. \n
 *
...
void Hospedeiro::imprimeInfo()
{
	string str_title = "Informações sobre o tripulante";
